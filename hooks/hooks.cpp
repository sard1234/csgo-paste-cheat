...
namespace hooks
{
	...
	void GUI_Init(IDirect3DDevice9* pDevice)
	{
		...
		// Menu fonts
		c_menu::get().futura_small = io.Fonts->AddFontFromMemoryTTF((void*)keybinds_font, sizeof(keybinds_font), 14.f, &m_config, io.Fonts->GetGlyphRangesCyrillic());
		c_menu::get().futura = io.Fonts->AddFontFromMemoryTTF((void*)keybinds_font, sizeof(keybinds_font), 16.f, &m_config, io.Fonts->GetGlyphRangesCyrillic());
		c_menu::get().futura_large = io.Fonts->AddFontFromMemoryTTF((void*)keybinds_font, sizeof(keybinds_font), 18.f, &m_config, io.Fonts->GetGlyphRangesCyrillic());
		c_menu::get().gotham = io.Fonts->AddFontFromMemoryTTF((void*)keybinds_font, sizeof(keybinds_font), 20.f, &m_config, io.Fonts->GetGlyphRangesCyrillic());
