...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    const ImVec4 hover_act = ImVec4(202 / 255.f, 202 / 255.f, 202 / 255.f, 1.f);
    const ImVec4 hover_dis = ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, 1.f);
    ...
    window->DrawList->AddRectFilled(check_bb.Min, check_bb.Max, GetColorU32(ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, it_filled->second)), 2.f * c_menu::get().dpi_scale);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int* current_item)
{
    ...
    const ImVec4 arrow_act = ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, 1.f);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, bool minimum_damage, float power)
{
    ...
    const ImU32 frame_col = GetColorU32(g.ActiveId == id ? ImGuiCol_FrameBgActive : g.HoveredId == id ? ImGuiCol_FrameBgHovered : ImGuiCol_FrameBg);
    const ImVec4 hover_act = ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, 1.f);
    const ImVec4 hover_dis = ImVec4(230 / 255.f, 73 / 255.f, 73 / 255.f, 1.f);
    const ImVec4 hover_off = ImVec4(230 / 255.f, 73 / 255.f, 73 / 255.f, 0.4f);
