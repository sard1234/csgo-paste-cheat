...
__forceinline void setup_render()
{
	...
	fonts[NAME] = create_font(crypt_str("Tahoma"), 11, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	...
	fonts[DAMAGE_MARKER] = create_font(crypt_str("Impact"), 16, FW_HEAVY, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
